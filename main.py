...
while True:
    ...
    for obj in visible_this_frame:
        ...
        detection_counter[obj] = detection_counter.get(obj, 0) + 1
    ...
    for obj in list(confirmed_objects):
        ...
        if obj not in visible_this_frame:
            ...
            if missing_counter[obj] >= DISAPPEAR_THRESHOLD:

                print(f"{obj} disappeared")

                save_event(obj, "disappeared")
    ...
    cv2.imshow("Eyes Of Rover", annotated_frame)
